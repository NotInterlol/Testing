...
public class ParkSelectionPanel extends JPanel {
    ...
    public ParkSelectionPanel(MainFrame frame,
        ...
        // Stacks the buttons
        regular.setBounds(centerX, startY, buttonWidth, buttonHeight);
        senior.setBounds(centerX, startY + buttonHeight + gap, buttonWidth, buttonHeight);
        pwd.setBounds(centerX, startY + 2 * (buttonHeight + gap), buttonWidth, buttonHeight);
